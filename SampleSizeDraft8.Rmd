...
The table below summarizes the conceptual relationship between Type I and Type II Error ($H_0$ is the Null Hypothesis (that there is no effect) and $H_A$ is the Alternative Hypothesis (that there is an effect): 
